...
public class Usergui {
	...
	private void initialize() {
		...
		formattedTextField.setBounds(6, 62, 587, 233);
		panel_1.add(formattedTextField);
		
		JButton btnSpeichern = new JButton("Speichern");
		btnSpeichern.setBounds(6, 295, 117, 29);
		panel_1.add(btnSpeichern);
		panel_1.setFocusTraversalPolicy(new FocusTraversalOnArray(new Component[]{lblNewLabel, lblUrlaub, comboBox, textField, formattedTextField, btnSpeichern}));
		...
		JLabel lblNewLabel_1 = new JLabel("\u00DCbersicht aller Urlaubs Kan\u00E4le");
